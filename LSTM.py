...
# Step 1: Data Scaling - Normalize the values to a range between 0 and 1 for efficient LSTM training
scaler = MinMaxScaler(feature_range=(0, 1))
scaled_data = scaler.fit_transform(data['Value'].values.reshape(-1, 1))

# Prepare data for LSTM model
# Step 2: Sequence Creation - Generate short, fixed-length sequences (12 months) from the data
...
# Step 3: LSTM Model Architecture - Defines the LSTM layers and a fully connected layer
...
for params in ParameterGrid(param_grid):
    ...
    # Calculate Test MSE
    # Step 4: Model Evaluation and Testing - Measure accuracy using Mean Squared Error (MSE)
...
# Step 5: Forecasting Future Values - Iteratively forecast the next 24 months of electricity consumption
